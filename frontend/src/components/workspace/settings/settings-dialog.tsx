...
import { PublishAccountsSettings } from "@/components/publish/publish-accounts-settings";
...
export function SettingsDialog(props: SettingsDialogProps) {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "publish", label: t.settings.sections.publish, icon: UploadIcon },
        ...
        <div className="grid min-h-0 flex-1 gap-4 md:grid-cols-[220px_1fr]">
          ...
          <ScrollArea className="h-full min-h-0 rounded-lg border">
            <div className="space-y-8 p-6">
              ...
              {activeSection === "publish" && <PublishAccountsSettings />}
